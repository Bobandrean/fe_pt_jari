...
const handleReport = async (id) => {
  // window.location.href = 'https://dev-stepup.hrultra.com/backend/api/v1/final_quiz/result/' + id
  window.location.href = 'http://localhost:8000/api/v1/final_quiz/result/' + id
}
